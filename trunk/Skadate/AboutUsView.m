...
- (void)viewDidLoad
{
    ...
    CGRect frame = CGRectMake (10, 11, 300, 43);
    segControl.frame = frame;
    segControl.clipsToBounds = YES;
    segControl.layer.cornerRadius = 9.0;
    ...
    UIImage* seg0 = [UIImage imageNamed:@"about_us_over.png"];
    if ([UIImage instancesRespondToSelector:@selector(imageWithRenderingMode:)])
        seg0 = [seg0 imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    [segControl setImage:seg0 forSegmentAtIndex:0];
    
    UIImage* seg1 = [UIImage imageNamed:@"terms_of_use.png"];
    if ([UIImage instancesRespondToSelector:@selector(imageWithRenderingMode:)])
        seg1 = [seg1 imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    [segControl setImage:seg1 forSegmentAtIndex:1];
    
    UIImage* seg2 = [UIImage imageNamed:@"privacy_policy.png"];
    if ([UIImage instancesRespondToSelector:@selector(imageWithRenderingMode:)])
        seg2 = [seg2 imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    [segControl setImage:seg2 forSegmentAtIndex:2];
    
    UIImage* seg3 = [UIImage imageNamed:@"full_version.png"];
    if ([UIImage instancesRespondToSelector:@selector(imageWithRenderingMode:)])
        seg3 = [seg3 imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    [segControl setImage:seg3 forSegmentAtIndex:3];
...
{
    int selectedsegment = (int)segControl.selectedSegmentIndex;
    ...
    if (selectedsegment==1) 
    {
        ...
        UIImage* seg0 = [UIImage imageNamed:@"about_us.png"];
        if ([UIImage instancesRespondToSelector:@selector(imageWithRenderingMode:)])
            seg0 = [seg0 imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
        [segControl setImage:seg0 forSegmentAtIndex:0];
        
        UIImage* seg1 = [UIImage imageNamed:@"terms_of_use_hover.png"];
        if ([UIImage instancesRespondToSelector:@selector(imageWithRenderingMode:)])
            seg1 = [seg1 imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
        [segControl setImage:seg1 forSegmentAtIndex:1];
    ...
    if (selectedsegment ==2)
    {
        ...
        UIImage* seg2 = [UIImage imageNamed:@"privacy_policy_hover.png"];
        if ([UIImage instancesRespondToSelector:@selector(imageWithRenderingMode:)])
            seg2 = [seg2 imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
        [segControl setImage:seg2 forSegmentAtIndex:2];
    ...
    if (selectedsegment ==3)
    {
        ...
        UIImage* seg3 = [UIImage imageNamed:@"full_version_over.png"];
        if ([UIImage instancesRespondToSelector:@selector(imageWithRenderingMode:)])
            seg3 = [seg3 imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
        [segControl setImage:seg3 forSegmentAtIndex:3];
