...
@interface HomeView : UIViewController <GADBannerViewDelegate,UIActionSheetDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate,UIPopoverControllerDelegate,UIAlertViewDelegate,NotificationCountDelegate,SKProductsRequestDelegate,SKPaymentTransactionObserver>
...
@property (retain, nonatomic) IBOutlet UILabel *lbRemoveAds;
