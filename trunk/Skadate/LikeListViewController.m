...
@synthesize domain;
@synthesize respData;
@synthesize likeslistConnection;
@synthesize profilePics;
@synthesize youLiked;
@synthesize likeConnection;
@synthesize UnlikeConnection;
...
{    
    ...
    likeslistConnection=[[[NSURLConnection alloc] initWithRequest:urlrequest delegate:self] autorelease];
...
{    
    ...
    if (connection==likeslistConnection) 
    {                      
    ...
    else if(connection==likeConnection)
    {                        
    ...
    else if(connection==UnlikeConnection)
    {        
        NSString *msgStr=(NSString*)[parsedData objectForKey:@"Message"];
        if([msgStr isEqualToString:@"Site suspended"])
        {            
...
{    
    ...
    {        
        ...
        NSURL *url = [NSURL URLWithString:[req stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding]];
        NSURLRequest *urlrequest = [NSURLRequest requestWithURL:url];
        likeConnection=[[[NSURLConnection alloc] initWithRequest:urlrequest delegate:self] autorelease];
    }
    else 
    {        
        ...
        NSURL *url = [NSURL URLWithString:[req stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding]];
        NSURLRequest *urlrequest = [NSURLRequest requestWithURL:url];
        UnlikeConnection=[[[NSURLConnection alloc] initWithRequest:urlrequest delegate:self] autorelease];
