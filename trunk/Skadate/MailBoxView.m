...
@synthesize imageArray,nameArray,table,segmentControl,messageSubjectArray,messageContentArray,messageId,conversationId,senderId,timeArray,urlReq,indicatorView,indicatorLabel,objIndicatorView,genders,domain;
...
- (void)viewDidLoad
{
    ...
    segmentControl.frame = CGRectMake (12, 12, 296,34);
    ...
    [mailboxlable setTextAlignment:NSTextAlignmentCenter];
    ...
    UIImage* seg0 = [UIImage imageNamed:@"Inbox small.png"];
    if ([UIImage instancesRespondToSelector:@selector(imageWithRenderingMode:)])
        seg0 = [seg0 imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    [segmentControl setImage:seg0 forSegmentAtIndex:0];
    
    UIImage* seg1 = [UIImage imageNamed:@"Send_tab_over.png"];
    if ([UIImage instancesRespondToSelector:@selector(imageWithRenderingMode:)])
        seg1 = [seg1 imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    [segmentControl setImage:seg1 forSegmentAtIndex:1];
...
-(IBAction) clickedSegmentContol
{
	...
	if (selectedsegment==1)
	{
        ...
        UIImage* seg0 = [UIImage imageNamed:@"Inbox_tab.png"];
        if ([UIImage instancesRespondToSelector:@selector(imageWithRenderingMode:)])
            seg0 = [seg0 imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
        [segmentControl setImage:seg0 forSegmentAtIndex:0];
        
        UIImage* seg1 = [UIImage imageNamed:@"Sent_tab.png"];
        if ([UIImage instancesRespondToSelector:@selector(imageWithRenderingMode:)])
            seg1 = [seg1 imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
        [segmentControl setImage:seg1 forSegmentAtIndex:1];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section==0) 
    {
        ...
        else
        {
            ...
            lblOfSubject.textAlignment=NSTextAlignmentLeft;
            ...
            lblOfTime.textAlignment=NSTextAlignmentLeft;
