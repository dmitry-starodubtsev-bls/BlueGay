...
@synthesize urlReq,indicatorView,indicatorLabel,objIndicatorView;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath 
{
    ...
    if (indexPath.section==0) 
    {
        ...
        {                       
            ...
            {
                float floatValue = [[placeArray objectAtIndex:indexPath.row] floatValue];
                
                if (floatValue<1) {
                    floatValue=floatValue*1000;
                    lblOfCountry.text=[NSString stringWithFormat:@"%f meters away",floatValue];
                    
                } else {
                
                    lblOfCountry.text=[NSString stringWithFormat:@"%@ kilometers away",[placeArray objectAtIndex:indexPath.row]];}
                NSLog([placeArray objectAtIndex:indexPath.row]);
                }
