...
@synthesize btnClose, chatMsgIdArray,chatSenderId,chatReciepientId,table,messageTimeArray,respData,urlReq,msgIdArray,senderId,reciepientId,chatNameArray,chatImageArray,chatTextArray,messageText,messageImageArray,messageNameArray,chatImg,msgImg;
@synthesize navBar;
@synthesize indicatorLabel;
@synthesize indicatorView;
@synthesize objIndicatorView;
...
- (void)viewDidLoad
{
    ...
    {
        resultCount = [NSString stringWithFormat:@"%@ Chats", ((SkadateAppDelegate *) [UIApplication sharedApplication].delegate).loggedNotifications];
    }
    
    if (resultCount == (id)[NSNull null])
    {
        lblNotifications.text = [NSString stringWithFormat:@"%@ Chats", @"0"];
    }
    else
    {
        lblNotifications.text = [NSString stringWithFormat:@"%d Chats", (int)chatItemCount];
    }
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section==0) 
    {
        ...
        lblOfNamechat.textAlignment=NSTextAlignmentLeft;
        ...
        lblOfText.textAlignment=NSTextAlignmentLeft;
