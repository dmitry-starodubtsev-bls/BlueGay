...
@synthesize segmentControl,tempScrollView,btnComposeMail,btnBookmark,btnChat,btnHome,indicatorView,indicatorLabel,objIndicatorView;
...
- (void)viewDidLoad
{
    ...
    UIImage* seg0 = [UIImage imageNamed:@"Info_tab.png"];
    ...
    UIImage* seg1 = [UIImage imageNamed:@"Photos_tab_over.png"];
    if ([UIImage instancesRespondToSelector:@selector(imageWithRenderingMode:)])
    ...
    [photoslab setTextAlignment:NSTextAlignmentCenter];
