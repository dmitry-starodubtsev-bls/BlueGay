...
@interface SignUPSecondView : UIViewController <UIPickerViewDataSource, UIPickerViewDelegate,NSXMLParserDelegate,UITextFieldDelegate,UIGestureRecognizerDelegate> 
{
    ...
    NSURLConnection *GetRegionURLConnection;
    NSURLConnection *GetcityURLConnection;
    NSURLConnection *GetZipURLConnection;
    NSURLConnection *forGettingIp;
    NSURLConnection *SignUpCon;
...
@property (nonatomic, retain) NSURLConnection *GetZipURLConnection;
@property (nonatomic, retain) NSURLConnection *forGettingIp;
