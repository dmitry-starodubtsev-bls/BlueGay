...
@synthesize GetZipURLConnection,forGettingIp;
...
@synthesize btnTOU,indicatorView,indicatorLabel,objIndicatorView;
    ...
    //{
        ...
        else 
        {
            ...
            {                
                ...
                imgBGCountry.image=[UIImage imageNamed:@"location_field3.png"];
                [btnSignUp setFrame:(CGRectMake(30, 635, 260, 45))];
            ...
            else
            {
                ...
                [btnSignUp setFrame:(CGRectMake(30, 550, 260, 45))];
            //    [btnSignUp setTitle:@"Register" forState:UIControlStateNormal];
            }
...
{    
    ...
    forGettingIp=[[[NSURLConnection alloc] initWithRequest:urlrequest delegate:self] autorelease];
...
{    
    int selectedsegment = (int)segmentCtrlMonth.selectedSegmentIndex;
...
- (IBAction) clickedSegCtrlDay:(id)sender
{
    ...
    int selectedsegment = (int)segmentCtrlDate.selectedSegmentIndex;
...
- (IBAction) clickedSegCtrlMonth:(id)sender
{
    ...
    int selectedsegment = (int)segmentCtrlYear.selectedSegmentIndex;
    if (selectedsegment==0) 
	{
        if (indexYearRange!=0) 
        {
...
- (IBAction)clickedSignUpButton:(id)sender
{
    ...
    SignUpCon= [[[NSURLConnection alloc] initWithRequest:urlrequest delegate:self] autorelease];
...
{    
    ...
    {		
        ...
        if (connection==GetRegionURLConnection) 
        {                        
            ...
            int c = (int)[stateNamesArray count];   // for handling none value
