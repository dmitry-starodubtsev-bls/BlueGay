...
@implementation eventAttendCell
...
-(void)layoutSubviews
{
    ...
    lbl.text=[NSString stringWithFormat:@"attending an event"];
    ...
    if ( ([newsFeedItem valueForKey:@"Time"] == (id)[NSNull null])
        ...
        || [[newsFeedItem valueForKey:@"Time"] isEqualToString:@""] )
    {
    ...
    //if(UI_USER_INTERFACE_IDIOM()==UIUserInterfaceIdiomPad)
    //{
    //    title_lbl.frame = CGRectMake(84, 60, 500, 25);
    //}
    //else
    //{
        title_lbl.frame = CGRectMake(84, 60, 220, 25);
    //}
    ...
    dispatch_async(queue1, ^{
        ...
        dispatch_sync(dispatch_get_main_queue(), ^{
            ...
            else
            {
                ...
                {                                                      
                    event_img=[UIImage imageNamed:@"man.png"];
                }
                else
                {
