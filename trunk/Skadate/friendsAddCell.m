...
{    
    ...
    //CGSize stringSize_friend2_lbl =[FrdName sizeWithFont:friend2_btn.titleLabel.font  constrainedToSize: constraintSize_friend2_lbl lineBreakMode: NSLineBreakByTruncatingTail];
    
    CGSize stringSize_friend2_lbl;
    
    CGRect expected2 = [FrdName boundingRectWithSize:constraintSize_friend2_lbl options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:friend2_btn.titleLabel.font } context:nil];
    stringSize_friend2_lbl = expected2.size;
    
    friend2_btn.titleLabel.lineBreakMode=NSLineBreakByTruncatingTail;
