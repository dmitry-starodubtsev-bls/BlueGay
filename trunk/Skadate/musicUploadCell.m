...
@implementation musicUploadCell
...
-(void)layoutSubviews
{
    ...
    lbl.text=[NSString stringWithFormat:@"added new music file"];
    ...
    UILabel *title_lbl=[[UILabel alloc]initWithFrame:CGRectMake(14, 83, 230, 25)];
    title_lbl.text=[NSString stringWithFormat:@"%@",[newsFeedItem valueForKey:@"Title"]];
    ...
    blogPostDis.text=[NSString stringWithFormat:@"%@",[newsFeedItem valueForKey:@"Description"]];
    ...
    if ( [[newsFeedItem valueForKey:@"likecount"] isEqualToString:@"NULL"]
        || ([newsFeedItem valueForKey:@"likecount"] == (id)[NSNull null])
        || [[newsFeedItem valueForKey:@"likecount"] isEqualToString:@"<null>"]
