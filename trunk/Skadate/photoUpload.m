...
{    
    ...
    //CGSize stringSize =[nameStr sizeWithFont:profileName.titleLabel.font  constrainedToSize: constraintSize lineBreakMode: NSLineBreakByTruncatingTail];
    
    CGSize stringSize;
    
    CGRect expected = [nameStr boundingRectWithSize:constraintSize options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:profileName.titleLabel.font} context:nil];
    stringSize = expected.size;
    
    profileName.titleLabel.lineBreakMode=NSLineBreakByTruncatingTail;
    ...
    lbl.text=[NSString stringWithFormat:@"uploaded new photo"];
    [lbl setTextColor:[UIColor blackColor]];
    lbl.font=[UIFont fontWithName:@"Ubuntu" size:14];
    [self.contentView addSubview:lbl];
    [lbl release];
    
    UIButton *btnUploadImage=[[[UIButton alloc]initWithFrame:CGRectMake(84, 65, 70, 70)] autorelease];
    btnUploadImage.layer.cornerRadius=6.0;
    btnUploadImage.layer.masksToBounds=YES;
    btnUploadImage.tag=index_row;  
    [btnUploadImage setImage:uploadedImg forState:normal]; 
        ...
        dispatch_sync(dispatch_get_main_queue(), ^{
            ...
            else
            {
                ...
                {                                                      
                    ...
                    {
                        uploadedImg =[UIImage imageNamed:@"event_default.png"];
                    }
                    else
                    {
                        uploadedImg =[UIImage imageNamed:@"DefaultUploadImg.png"];
    ...
    [self.contentView addSubview:btnUploadImage];
    [btnUploadImage addTarget:objNewsFeedsView action:@selector(uploadedImageButtonClicked:) forControlEvents:UIControlEventTouchUpInside];
  
    UILabel *time_lbl=[[UILabel alloc]initWithFrame:CGRectMake(84, 138, 150, 25)];
    ...
    [comment_btn setFrame:CGRectMake(124, 163, 70, 20)];
    ...
    if (!([[newsFeedItem valueForKey:@"userId"] isEqualToString:((SkadateAppDelegate *) [UIApplication sharedApplication].delegate).loggedProfileID]))
    {
        ...
        [like_btn setFrame:CGRectMake(252, 163, 50, 20)];
    ...
    [commentimg_btn setFrame:CGRectMake(84, 165, 17, 17)];
    ...
    [commentcount_btn setFrame:CGRectMake(103, 165, 15, 15)];
    ...
    [likesview_btn setFrame:CGRectMake(214, 165, 17, 17)];
    ...
    [likescount_btn setFrame:CGRectMake(234, 165, 15, 15)];
