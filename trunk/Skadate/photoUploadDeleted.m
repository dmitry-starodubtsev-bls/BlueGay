...
@implementation photoUploadDeleted
...
{    
    ...
    UILabel *uploadedImg=[[UILabel alloc]initWithFrame:CGRectMake(84, 63, 220, 25)];
    uploadedImg.text=[NSString stringWithFormat:@"Image has been deleted"];
    [uploadedImg setTextColor:[UIColor blackColor]];
    uploadedImg.font=[UIFont fontWithName:@"Ubuntu" size:14];
    [self.contentView addSubview:uploadedImg];
    [uploadedImg release];
          
    UILabel *time_lbl=[[UILabel alloc]initWithFrame:CGRectMake(84, 90, 150, 25)];
    ...
    [comment_btn setFrame:CGRectMake(124, 122, 70, 20)];
    ...
    {        
        ...
        [like_btn setFrame:CGRectMake(252, 122, 50, 20)];
    ...
    [commentimg_btn setFrame:CGRectMake(84, 124, 17, 17)];
    ...
    [commentcount_btn setFrame:CGRectMake(103, 124, 15, 15)];
    ...
    [likesview_btn setFrame:CGRectMake(214, 124, 17, 17)];
    ...
    [likescount_btn setFrame:CGRectMake(234, 124, 15, 15)];
