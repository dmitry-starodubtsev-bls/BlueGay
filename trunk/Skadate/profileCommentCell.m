...
{    
    ...
    //CGSize stringSize2 =[nameStr2 sizeWithFont:profileName_2.titleLabel.font  constrainedToSize: constraintSize2 lineBreakMode: NSLineBreakByTruncatingTail];
    
    CGSize stringSize2;
    
    CGRect expected2 = [nameStr2 boundingRectWithSize:constraintSize2 options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:profileName_2.titleLabel.font } context:nil];
    stringSize2 = expected2.size;
    
    profileName_2.titleLabel.lineBreakMode=NSLineBreakByTruncatingTail;
