...
@implementation statusUpdateCell
...
{    
    ...
    [comment_btn setFrame:CGRectMake(124, 93, 70, 20)];
    ...
    {                
        ...
        [like_btn setFrame:CGRectMake(252, 93, 50, 20)];
    ...
    [commentimg_btn setFrame:CGRectMake(84, 95, 17, 17)];
    ...
    if ( ([newsFeedItem valueForKey:@"Comment"] == (id)[NSNull null])
        ...
        || [[newsFeedItem valueForKey:@"Comment"] isEqual:@""] )
    {        
        commentcountStr=@"";
    }
    else
    ...
    [commentcount_btn setFrame:CGRectMake(103, 95, 15, 15)];
    ...
    [likesview_btn setFrame:CGRectMake(214, 95, 17, 17)];
    ...
    if ( ([newsFeedItem valueForKey:@"likecount"] == (id)[NSNull null])
        ...
        || [[newsFeedItem valueForKey:@"likecount"] isEqual:@""] )
    {        
        likecountStr = @"";
    }
    else
    ...
    [likescount_btn setFrame:CGRectMake(234, 95, 15, 15)];
